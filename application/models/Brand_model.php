    ...
    public function get_brand_list()
    {
        ...
        foreach ($brand_search_res as $row) {
            ...
            if ($row['status'] == '1') {
                ...
                $operate .= '<a class="btn btn-warning btn-xs update_active_status mr-1" data-table="brands" title="Deactivate" href="javascript:void(0)" data-id="' . $row['id'] . '" data-status="' . $row['status'] . '" ><i class="fa fa-eye-slash"></i></a>';
            } else {
                $tempRow['status'] = '<a class="badge badge-danger text-white" >Inactive</a>';

                $operate .= '<a class="btn btn-primary mr-1 btn-xs update_active_status" data-table="brands" href="javascript:void(0)" title="Active" data-id="' . $row['id'] . '" data-status="' . $row['status'] . '" ><i class="fa fa-eye"></i></a>';
            }
