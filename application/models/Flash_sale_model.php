...
class Flash_sale_model extends CI_Model
{
    ...
    public function get_flash_list()
    {
        ...
        foreach ($city_search_res as $row) {
            ...
            $operate = "";
            if ($row['status'] !== '0') {
                $operate = ' <a href="javascript:void(0)" class="edit_btn btn btn-primary btn-xs mr-1 mb-1" title="Edit" data-id="' . $row['id'] . '" data-url="admin/Flash_sale/"><i class="fa fa-pen"></i></a>';
            }
            $operate .= "<a href='./view_sale?edit_id=" . $row['id'] . "'  class='btn btn-primary btn-xs mr-1 mb-1' title='View'><i class='fa fa-eye'></i></a>";
            $operate .= ' <a  href="javascript:void(0)" class="btn btn-danger btn-xs mr-1 mb-1" title="Delete" data-id="' . $row['id'] . '" id="delete-flash-sale" ><i class="fa fa-trash"></i></a>';
            $tempRow['id'] = $row['id'];
            ...
            $tempRow['image'] = "<a href='" . $row['image'] . "' data-toggle='lightbox'> <img src='" . $row['image'] . "' class='img-fluid rounded col-md-3'></a>";
