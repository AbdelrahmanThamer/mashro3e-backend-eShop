            ...
            preConfirm: function() {
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: base_url + 'admin/orders/update_orders',
                        data: { orderid: orderid, seller_notes: seller_notes, pickup_time: pickup_time, field: field, val: val, deliver_by: deliver_by, json: json, [csrfName]: csrfHash },
                        dataType: 'json',
                        success: function(result) {
...
$(document).on('click', '#notification_count', function(e, rows) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            html += '<a href="' + base_url + 'admin/Notification_settings/manage_ststem_notifications' + '" class="dropdown-item dropdown-footer">See All Messages</a>';
...
// search flash-sale-product



// $('.search_flash_sale_product').each(function() {
//     $(this).select2({
//         ajax: {
...
$('#offer_type').change(function(e) {
    ...
    if (($('#offer_type').val() == 'categories' || $('#offer_type').val() == 'all_products')) {
